...
* MIT License
*
* Customized by Sgu_fw
*
*/
(function($) {

  function SGU_FWAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SGU_FWAjaxChosen.prototype.init = function() {
  ...
  SGU_FWAjaxChosen.prototype.events = function() {
  ...
  SGU_FWAjaxChosen.prototype.search_field_focused = function() {
  ...
  SGU_FWAjaxChosen.prototype.search_welcome_message = function() {
  ...
  SGU_FWAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('sgu_fw-chosen', _this.options.data).done( function( response ) {
  ...
  SGU_FWAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.sgu_fw-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.SGU_FWChosenOrder($hidden_value, true);
  ...
  $.fn.SGU_FWAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new SGU_FWAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, SGU_FWAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SGU_FWAbstractChosenOrder = (function() {

    function SGU_FWAbstractChosenOrder() {}

    SGU_FWAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    SGU_FWAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    SGU_FWAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SGU_FWAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    SGU_FWAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    SGU_FWAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    SGU_FWAbstractChosenOrder.SGU_FWChosenOrder = function(select, order, force) {
    ...
    return SGU_FWAbstractChosenOrder;
  ...
  $.fn.extend({
    SGU_FWChosenOrder: function(order, force) {
      return _SGU_FWChosenOrder.SGU_FWChosenOrder(this, order, force);
    }
  });

  this._SGU_FWChosenOrder = (function(_super) {
    __extends(_SGU_FWChosenOrder, _super);

    function _SGU_FWChosenOrder() {
      _ref = _SGU_FWChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SGU_FWChosenOrder.relAttributeName = 'data-option-array-index';

    _SGU_FWChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SGU_FWChosenOrder.getDOMElement = function(element) {
    ...
    _SGU_FWChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _SGU_FWChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SGU_FWChosenOrder;

  })(SGU_FWAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('sgu_fw-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('sgu_fw-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Sgu_fw: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Sgu_fw: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectSGU_FW = FormSerializer.serializeObject;
    $.fn.serializeJSONSGU_FW   = FormSerializer.serializeJSON;
  }
