 ...
 * -----------------------------------------------------------
 *
 * Sgu_fw Framework Gutenberg Block
...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.sgu_fw_gutenberg_blocks ) { return; }

  Object.values(window.sgu_fw_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'sgu_fw-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary sgu_fw-shortcode-button',
              onClick: function () {
                window.sgu_fw_gutenberg_props = props;
              },
            }, block.button_title ),
