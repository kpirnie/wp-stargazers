 ...
 *
 */
if ( ! class_exists( 'SGU_FW_Field_color' ) ) {
  class SGU_FW_Field_color extends SGU_FW_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="sgu_fw-color"'. $default_attr . $this->field_attributes() .'/>';
