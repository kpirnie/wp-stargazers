 ...
 *
 */
if ( ! class_exists( 'SGU_FW_Field_sortable' ) ) {
  class SGU_FW_Field_sortable extends SGU_FW_Fields {
    ...
    public function render() {
      ...
      echo '<div class="sgu_fw-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="sgu_fw-sortable-item">';

          echo '<div class="sgu_fw-sortable-content">';
          ...
          SGU_FW::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="sgu_fw-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
