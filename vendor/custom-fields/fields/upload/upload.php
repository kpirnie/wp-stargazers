 ...
 *
 */
if ( ! class_exists( 'SGU_FW_Field_upload' ) ) {
  class SGU_FW_Field_upload extends SGU_FW_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        echo '<div class="sgu_fw--preview'. esc_attr( $preview_hidden ) .'">';
      ...
      echo '<a href="#" class="button button-primary sgu_fw--button" data-library="'. esc_attr( $library ) .'">'. $args['button_title'] .'</a>';
      echo '<a href="#" class="button button-secondary sgu_fw-warning-primary sgu_fw--remove'. esc_attr( $hidden ) .'">'. $args['remove_title'] .'</a>';
      echo '</div>';
