 ...
 *
 */
if ( ! class_exists( 'SGU_FW_Field_textarea' ) ) {
  class SGU_FW_Field_textarea extends SGU_FW_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( SGU_FW::$shortcode_instances ) ) ? SGU_FW::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary sgu_fw-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';
