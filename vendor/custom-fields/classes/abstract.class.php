 ...
 *
 */
if ( ! class_exists( 'SGU_FW_Abstract' ) ) {
#[AllowDynamicProperties]
abstract class SGU_FW_Abstract {
  ...
  public function __construct() {
    ...
    if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
      ...
      SGU_FW::$css = apply_filters( "sgu_fw_{$this->unique}_output_css", SGU_FW::$css, $this );
    }
  ...
  public function recursive_output_css( $fields = array(), $combine_field = array() ) {
    ...
    if ( ! empty( $fields ) ) {
      ...
      foreach ( $fields as $field ) {
        ...
        $field_class  = 'SGU_FW_Field_' . $field_type;
